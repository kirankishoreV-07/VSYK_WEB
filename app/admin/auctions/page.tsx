...
import { Gavel, Trophy, Radio, CalendarClock } from "lucide-react";
import { useAdminAuctions } from "@/lib/admin-queries";
...
export default function AdminAuctionsPage() {
  const { data, isLoading } = useAdminAuctions();
  ...
  return (
    <>
      <PageHeader
        title="Auctions"
        subtitle="Monitor live bidding and auction outcomes across all groups."
      />
