      ...
      <div className="container-x">
        <div className="grid items-center gap-12 lg:grid-cols-[1fr,1.2fr]">
          ...
          >
            ...
            >
              <p className="font-display text-base font-bold tracking-[0.08em] text-white">MR VENKATESAN.R</p>
          ...
          >
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-white/80 sm:text-lg">
              Guided by Managing Director <span className="font-bold">MR VENKATESAN.R</span>, VSYK CHITS is built on three
            ...
            <figure className="mt-8 rounded-3xl border border-white/15 bg-white/[0.06] p-6 backdrop-blur-md sm:p-7">
              ...
              <figcaption className="mt-5 flex items-center gap-3 text-sm text-white/70">
                ...
                <span className="font-display tracking-[0.05em]">MR VENKATESAN.R</span> · Managing Director, VSYK CHITS
              </figcaption>
            </figure>
          </motion.div>
        </div>
